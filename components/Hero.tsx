    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-obsidian">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <h2 className="text-gold-400 tracking-[0.3em] uppercase text-xs mb-6 animate-fade-in">
          {t('hero.labelWeb', 'Premium Automotive Protection Atelier')}
        </h2>
        <h1 className="text-5xl md:text-7xl font-serif text-white mb-8 leading-tight animate-slide-up whitespace-pre-line">
          {t('hero.title')}
        </h1>
        <p className="text-neutral-400 max-w-xl mx-auto mb-12 font-light leading-relaxed animate-slide-up word-keep-all whitespace-pre-line" style={{ animationDelay: '0.2s' }}>
          {t('hero.subtitle')}
        </p>
